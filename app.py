...
AUTH0_CLIENT_ID='XIUhChL5xQcUHIHwy3yJhjXUsMsRH1ur'
AUTH0_DOMAIN='dev-4ejeflp3.us.auth0.com' 
AUTH0_AUDIENCE='http://localhost:5000' 
AUTH0_CALLBACK_URL='http://127.0.0.1:5000/'
AUTH0_BASE_URL='https://dev-4ejeflp3.us.auth0.com'
AUTH0_CLIENT_SECRET='_VGGtiAY9BpX5ZrEtDH6aLHRZ47YcM9K4HpgGuXiL3f4tN3O-DMVoKFIvtFDNiqj'
...
auth0 = oauth.register(
    'auth0',
    client_id='XIUhChL5xQcUHIHwy3yJhjXUsMsRH1ur',
    client_secret='_VGGtiAY9BpX5ZrEtDH6aLHRZ47YcM9K4HpgGuXiL3f4tN3O-DMVoKFIvtFDNiqj',
    api_base_url='https://dev-4ejeflp3.us.auth0.com',
	access_token_url='https://dev-4ejeflp3.us.auth0.com/oauth/token',
    authorize_url='https://dev-4ejeflp3.us.auth0.com/authorize',
    client_kwargs={
...
# 	# 	redirect_uri='https://{AUTH0_DOMAIN}/authorize?audience={AUTH0_AUDIENCE}&response_type=token&client_id={AUTH0_CLIENT_ID}&redirect_uri={AUTH0_CALLBACK_URL}')
